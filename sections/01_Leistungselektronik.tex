...
\includegraphics[width=\columnwidth]{images/V1B3.png}
...
\includegraphics[width=\columnwidth]{images/V1B4.png}

\subsubsection{pn-Übergang}
\begin{minipage}[c]{0.48\columnwidth}
    \includegraphics[width=\columnwidth]{images/V1B5.png}\\
\end{minipage}
\hfill
\begin{minipage}[c]{0.48\columnwidth}
...
\includegraphics[width=\columnwidth]{images/V1B6.png}\\

\subsubsection{Durchflussrichtung}
\includegraphics[width=9cm]{images/V1B7.png}\\
Die Spannungsquelle ist an den pn-Übergang in die Durchlassrichtung angeschlossen.\\
Die Spannung $U$ \textbf{verringert} die Breite der Raumladungszone.\\
Wenn $U>U_D$ ist, denn die Raumladungszone ist abgebaut und der Strom 
Fliesst über den pn-Übergang.\\

\subsubsection{Sperrrichtung}
\includegraphics[width=9cm]{images/V1B8.png}\\
Die Spannungsquelle ist an den pn-Übergang in die Sperrrichtung angeschlossen.\\
Die Spannung U \textbf{vergrössert} die Breite der Raumladungszone.\\
Der Strom kann nicht über den pn-Übergang fliessen.\\

\subsubsection{Kennlinien der Diode 1N914}
\includegraphics[width=9cm]{images/V1B9.png}\\
